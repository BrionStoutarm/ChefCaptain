...
#include "ChefCaptain/GridCell.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeGridCell() {}
// Cross Module References
	CHEFCAPTAIN_API UClass* Z_Construct_UClass_AGridCell_NoRegister();
	CHEFCAPTAIN_API UClass* Z_Construct_UClass_AGridCell();
...
// End Cross Module References
	...
	template<> CHEFCAPTAIN_API UClass* StaticClass<AGridCell>()
	{
		return AGridCell::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(AGridCell);
	struct Z_CompiledInDeferFile_FID_ChefCaptain_Source_ChefCaptain_GridCell_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ChefCaptain_Source_ChefCaptain_GridCell_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AGridCell, AGridCell::StaticClass, TEXT("AGridCell"), &Z_Registration_Info_UClass_AGridCell, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AGridCell), 466766171U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ChefCaptain_Source_ChefCaptain_GridCell_h_3366136632(TEXT("/Script/ChefCaptain"),
		Z_CompiledInDeferFile_FID_ChefCaptain_Source_ChefCaptain_GridCell_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_ChefCaptain_Source_ChefCaptain_GridCell_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
