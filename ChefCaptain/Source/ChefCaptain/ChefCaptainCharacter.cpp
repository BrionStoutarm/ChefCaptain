...
//////////////////////////////////////////////////////////////////////////
// AChefCaptainCharacter

AChefCaptainCharacter::AChefCaptainCharacter()
{
...
void AChefCaptainCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("Turn Right / Left Gamepad", this, &AChefCaptainCharacter::TurnAtRate);
...
void AChefCaptainCharacter::LookUpAtRate(float Rate)
{
	// calculate delta for this frame from the rate information
	AddControllerPitchInput(Rate * TurnRateGamepad * GetWorld()->GetDeltaSeconds());
}

void AChefCaptainCharacter::MoveForward(float Value)
{
...
void AChefCaptainCharacter::MoveRight(float Value)
{
	if ( (Controller != nullptr) && (Value != 0.0f) )
	{
